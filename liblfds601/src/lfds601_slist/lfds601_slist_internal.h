...
/***** defines *****/
#define LFDS601_SLIST_USER_DATA  0
#define LFDS601_SLIST_FLAGS      1

#define LFDS601_SLIST_NO_FLAGS      0x0
#define LFDS601_SLIST_FLAG_DELETED  0x1

/***** structures *****/
#pragma pack( push, LFDS601_ALIGN_SINGLE_POINTER )
...
void lfds601_slist_internal_link_element_to_head( struct lfds601_slist_state *lfds601_slist_state, struct lfds601_slist_element *volatile se );
